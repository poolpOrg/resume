...
\item	\textbf{OpenSMTPD}: founder and main developer\\
  ...
  https://www.plakar.io\\
  https://github.com/PlakarKorp/plakar.git\\
\end{itemize}
...
\item	\textbf{Capitole du Libre 2025}: "Plakar : moteur de sauvegarde immuable, v\'erifiable et distribuable"\\
  https://www.youtube.com/watch?v=k8\_BzwWN-3Y\\
\item	\textbf{Golang Nantes 2026}: "Content-defined chunking" (lightning talk)\\
  https://www.youtube.com/watch?v=hIRrcLmSsPY\\
\item	\textbf{Cloud Native Days France 2026}: "La r\'esilience Cloud Native avec la solution open source Plakar"\\
  https://www.youtube.com/watch?v=iIDqvY7-x80\\
\end{itemize}

\textbf{Podcasts}
\begin{itemize}
\item	\textbf{FLOSS Weekly 543 (2019)}: "OpenSMTPD"\\
  https://www.youtube.com/watch?v=tPjj-RpV3-w\\
\item	\textbf{DevOps and Docker Talk, Bret Fisher (2026)}: "Backup S3, Google Drive, iCloud, Notion with Plakar"\\
  https://www.youtube.com/watch?v=OPRK5osKQHI\\
\item	\textbf{\`A la french (2026)}: "Ils ont effac\'e la prod ! Histoires v\'ecues de backup, ran\c{c}ons et clouds d\'efaillants"\\
  https://www.youtube.com/watch?v=Unp40gp3WRs\\
\item	\textbf{Certo Modo}: "Reliability Rebels", episode 15\\
  https://www.youtube.com/watch?v=odFMnHACHBI\\
\end{itemize}

\textbf{Press}
\begin{itemize}
\item	\textbf{MISC 135 (2024)}: "R\'eduire la surface d'attaque avec pledge(2)"\\
  https://connect.ed-diamond.com/misc/misc-135/openbsd-reduire-la-surface-d-attaque-avec-pledge2\\
\item	\textbf{MISC 137 (2025)}: "S\'ecuriser les cl\'es priv\'ees avec la s\'eparation de privil\`eges cryptographiques"\\
  https://connect.ed-diamond.com/misc/misc-137/securiser-les-cles-privees-avec-la-separation-de-privileges-cryptographiques\\
\item	\textbf{MISC 145 (2026)}: "D\'evoiler son syst\`eme de fichiers avec unveil(2)"\\
  https://connect.ed-diamond.com/misc/misc-145/openbsd-devoiler-son-systeme-de-fichiers-avec-unveil2\\
\end{itemize}
